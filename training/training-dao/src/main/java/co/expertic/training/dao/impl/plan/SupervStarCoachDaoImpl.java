...
public class SupervStarCoachDaoImpl extends BaseDAOImpl<SupervStarCoach> implements SupervStarCoachDao {
    ...
    public List<SupervStarCoachDTO> findPaginate(int first, int max, String order, String filter) throws Exception {
        ...
        StringBuilder builder = new StringBuilder();
        builder.append("select new co.expertic.training.model.dto.SupervStarCoachDTO(a.supervStarCoachId,");
    ...
    public List<UserAssignedSupervisorDTO> findBySupervisorId(Integer userId) throws Exception {
        StringBuilder builder = new StringBuilder();
        builder.append("select new co.expertic.training.model.dto.UserAssignedSupervisorDTO( ");
