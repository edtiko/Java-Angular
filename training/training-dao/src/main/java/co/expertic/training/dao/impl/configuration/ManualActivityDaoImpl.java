...
import co.expertic.training.dao.configuration.ManualActivityDao;
...
public class ManualActivityDaoImpl extends BaseDAOImpl<ManualActivity> implements ManualActivityDao{
    ...
    public List<ActivityCalendarDTO> findByUserId(Integer userId) throws DAOException {
        ...
        sql.append("SELECT new co.expertic.training.model.dto.ActivityCalendarDTO(ma.manualActivityId, ma.name, ma.description, ma.sportId.sportId, ma.userId.userId  )");
