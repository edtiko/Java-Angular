...
public class ActivityDaoImpl extends BaseDAOImpl<Activity> implements ActivityDao {
    ...
    public List<ActivityDTO> findPaginate(int first, int max, String order, String filter) throws Exception {
        ...
        StringBuilder builder = new StringBuilder();
        builder.append("select new co.expertic.training.model.dto.ActivityDTO(a.activityId,");
    ...
    public List<ActivityCalendarDTO> findByUserDiscipline(Integer usuarioId) throws Exception {
        StringBuilder builder = new StringBuilder();
        builder.append("SELECT new co.expertic.training.model.dto.ActivityCalendarDTO(a.activityId, a.name, a.description, a.modalityId.modalityId, a.objectiveId.objectiveId, a.sportId.sportId, a.physiologicalCapacityId.name ) ");
    ...
    public List<ActivityMovilDTO> findActivityDefaultByUserDiscipline(Integer usuarioId) throws Exception {
        StringBuilder builder = new StringBuilder();
        builder.append("SELECT new co.expertic.training.model.dto.ActivityMovilDTO( ");
    ...
    public List<ActivityMovilDTO> findActivityReplaceByActivityMovil(Integer activityId) throws Exception {
        StringBuilder builder = new StringBuilder();
        builder.append("SELECT DISTINCT new co.expertic.training.model.dto.ActivityMovilDTO( a ) ");
    ...
    public List<ActivityMovilDTO> findManualActivitiesMovilByUserId(Integer userId) throws Exception {
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT new co.expertic.training.model.dto.ActivityMovilDTO(ma.manualActivityId, ma.name, ma.description, ma.sportId.sportId, ma.sportId.icon  )");
