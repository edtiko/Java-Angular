...
public class UserProfileDaoImpl extends BaseDAOImpl<UserProfile> implements UserProfileDao {
    ...
    public DashboardDTO findDashboardDTOByUserId(Integer id) throws Exception {
        ...
        sql.append("u.userId.countryId.name,u.ageSport, u.ppm, u.power, u.sportsAchievements, u.aboutMe, u.modalityId.name, ");
        sql.append("u.userId.twitterPage, u.userId.instagramPage, u.userId.webPage, u.vo2Running, u.vo2Ciclismo, u.injuryId,");
        sql.append("u.disease, u.environmentId, u.weatherId, u.objectiveId, u.competenceDate, u.availableTime,  u.testDistance, u.testDistanceN) ");
        sql.append("FROM UserProfile u ");
        //sql.append("LEFT JOIN u.objectiveId o ");
        sql.append("WHERE u.userId.userId = :id ");
