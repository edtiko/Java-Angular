...
public class VideoUser implements Serializable {
    ...
    @Id
    @Basic(optional = false)@SequenceGenerator(name = "video_user_seq", sequenceName = "video_user_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "video_user_seq")
