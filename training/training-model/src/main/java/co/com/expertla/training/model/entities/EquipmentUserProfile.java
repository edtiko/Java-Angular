...
public class EquipmentUserProfile implements Serializable {
    ...
    @Id
    @Basic(optional = false)@SequenceGenerator(name = "equipment_user_profile_seq", sequenceName = "equipment_user_profile_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "equipment_user_profile_seq")
