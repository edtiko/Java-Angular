...
//                        $scope.objectives.unshift({objectiveId: -1, name: 'Seleccione', level: ''});
        ...
        $scope.showTooltipEnvironment = function () {
          $scope.showMessage("Indique como es la topograf\u00eda del lugar en el que usted desarrollar\u00e1 las actividades deportivas",1);  
        };
        
        $scope.showTooltipWeather = function () {
          $scope.showMessage("Indique cual es la condici\u00f3n atmosf\u00e9rica del lugar en el que usted desarrollar\u00e1 las actividades deportivas.",1);  
        };
        
        $scope.showTooltipSportAge = function () {
          $scope.showMessage("Corresponde al tiempo (a\u00f1os) que usted ha dedicado de manera continua a la ejecuci\u00f3n de una modalidad deportiva ",1);  
        };
        
        $scope.showTooltipPpm = function () {
          $scope.showMessage("Corresponde a las pulsaciones por minuto. El valor registrado en este campo corresponder\u00e1 al resultante de una prueba de esfuerzo vigente,  para esto,  usted debe realizar una prueba en carretera por un per\u00edodo de 20 min,  en el que deber\u00e1 desplazarse en plano o loma durante el tiempo indicado, lo m\u00e1s r\u00e1pido posible,  con la ayuda del puls\u00f3metro guarde las pulsaciones promedio del tiempo de la prueba.",1);  
        };
        
        $scope.showTooltipPower = function () {
          $scope.showMessage("El valor registrado en este campo corresponder\u00e1 al resultante de una prueba de esfuerzo vigente,  para esto,  usted debe realizar una prueba en carretera por un per\u00edodo de 20 min,  en el que deber\u00e1 desplazarse en plano o loma durante el tiempo indicado, lo m\u00e1s r\u00e1pido posible,  con la ayuda de un potenciometro guarde las pulsaciones promedio del tiempo de la prueba.",1);  
        };
        // Survey Controller //
