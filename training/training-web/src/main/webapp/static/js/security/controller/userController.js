//trainingApp.controller('RegisterUserController', ['$scope', 'UserService', '$window', 
//    'DisciplineService', 'RoleService', function ($scope, UserService,
...
//        };
//
//        $scope.createUser = function (user,file) {
