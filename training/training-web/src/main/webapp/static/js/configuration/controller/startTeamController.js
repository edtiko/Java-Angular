trainingApp.controller('StartTeamController', function ($scope, StartTeamService,
    ...
    $scope.getStarTeamPaginate = function () {
        $scope.promise = StartTeamService.getPaginate($scope.query, function (response) {
    ...
    $scope.updateStarTeam = function (starTeam) {
        ...
        StartTeamService.mergeStarTeam(starTeam)
                .then(
                        function (d) {
                            if (d.status == 'success') {
                                $scope.resetStarTeam();
    ...
    $scope.deleteStarTeam = function (starTeam) {
        StartTeamService.deleteStarTeam(starTeam)
                .then(
                        function (d) {
                            if (d.status == 'success') {
                                $scope.resetStarTeam();
