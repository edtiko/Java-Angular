trainingApp.controller("MailCoachController", ['$scope', 'MailService', '$window', '$mdDialog',
    function ($scope, MailService, $window, $mdDialog) {
        ...
        $scope.views = {
            received: 'static/views/athleteCoachDetail/mail/received.html',
            sent: 'static/views/athleteCoachDetail/mail/sent.html',
            mailSelected: 'static/views/athleteCoachDetail/mail/mailSelected.html'
        };
