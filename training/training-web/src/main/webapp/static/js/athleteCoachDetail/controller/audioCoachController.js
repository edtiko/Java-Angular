trainingApp.controller("AudioCoachController", ['$scope', 'AudioMessageService', '$window', '$mdDialog', '$q', function ($scope, AudioMessageService, $window, $mdDialog, $q) {
        ...
        $scope.showRecord = function () {
            $mdDialog.show({
                ...
                scope: $scope.$new(),
                templateUrl: 'static/views/athleteCoachDetail/audio/recordModal.html',
        ...
        self.getAudios = function () {
            ...
            self.sendedAudios(tipoPlan, $scope.roleSelected,userId, toUserId, function (data) {
