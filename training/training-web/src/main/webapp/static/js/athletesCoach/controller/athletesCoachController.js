trainingApp.controller('AthletesCoachController', ['$scope', 'ExternalCoachService', '$window',
    function ($scope, ExternalCoachService, $window) {
        ...
        self.getAthletes = function () {
            ExternalCoachService.fetchAthletes($scope.userSession.userId, "ACTIVE").then(
                    function (data) {
