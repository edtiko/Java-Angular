trainingApp.controller("VideoAthleteCoachController", ['$scope', 'VideoService', 'UserService', '$timeout', '$mdDialog', '$window', '$http',
    function ($scope, VideoService, UserService, $timeout, $mdDialog, $window, $http) {
        ...
        $scope.showRecord = function () {
            $mdDialog.show({
                ...
                scope: $scope.$new(),
                templateUrl: 'static/views/athleteCoach/video/recordModal.html',
        ...
        $scope.showVideo = function () {
            $mdDialog.show({
                ...
                scope: $scope.$new(),
                templateUrl: 'static/views/athleteCoach/video/showVideoModal.html',
                parent: angular.element(document.body),
                clickOutsideToClose: false,
                fullscreen: $scope.customFullscreen
            });
        ...
        self.getVideos = function () {
            var tipoPlan = "EXT";
            self.receivedVideos(tipoPlan, $scope.roleSelected, $scope.userSession.userId, $scope.toUserId, function (data) {
                $scope.received = data.output;
                $scope.loadingReceived = true;

            });
            self.sendedVideos(tipoPlan, $scope.roleSelected, $scope.userSession.userId, $scope.toUserId, function (data) {
                $scope.sended = data.output;
                $scope.loadingSent = true;

            });

            self.getAvailableVideos($scope.planSelected.id, $scope.userSession.userId, $scope.toUserId, tipoPlan, $scope.roleSelected,
                    function (data) {
