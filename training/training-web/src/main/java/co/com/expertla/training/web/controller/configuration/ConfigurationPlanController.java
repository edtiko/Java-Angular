...
public class ConfigurationPlanController {
     ...
     * @return
     */
    @RequestMapping(value = "configurationPlan/create", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "configurationPlan/update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "configurationPlan/delete", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/configurationPlan/get/all", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/configurationPlan/paginated/{planId}", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
