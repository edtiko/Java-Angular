...
import co.expertic.training.service.security.ModuleService;
import co.expertic.training.service.security.OptionService;
...
public class ModuleController {
    ...
    public ResponseEntity<ResponseService> createModule(@RequestBody Module module) {
        ...
        try {
            ...
            if (listModuleName != null && !listModuleName.isEmpty()) {
                responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.module", "msgNombreExiste"));
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.module", "msgRegistroCreado"));
    ...
    public ResponseEntity<ResponseService> updateModule(@RequestBody Module module) {
        ...
        try {
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.module", "msgRegistroEditado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(ModuleController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public ResponseEntity<ResponseService> deleteModule(@RequestBody Module module) {
        ...
        try {
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.module", "msgRegistroEliminado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(ModuleController.class.getName()).log(Level.SEVERE, null, ex);
