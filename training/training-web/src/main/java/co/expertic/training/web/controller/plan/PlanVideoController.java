...
public class PlanVideoController {
    ...
    public @ResponseBody
    ResponseEntity<ResponseService> getAvailableVideos(@PathVariable("coachAssignedPlanId") Integer coachAssignedPlanId, @PathVariable("userId") Integer userId,
    ...
    ResponseEntity<ResponseService> getVideosReceived(@PathVariable("coachAssignedPlanId") Integer coachAssignedPlanId, @PathVariable("fromUserId") Integer fromUserId,
        ...
        try {
            if (tipoPlan.equals(COACH_INTERNO)) {
                count = planVideoService.getCountVideosReceived(coachAssignedPlanId, fromUserId, toUserId, roleSelected);
            } else if (tipoPlan.equals(COACH_EXTERNO)) {
                count = planVideoService.getCountVideosReceivedExt(coachAssignedPlanId, fromUserId);
            }
            responseService.setStatus(StatusResponse.SUCCESS.getName());
