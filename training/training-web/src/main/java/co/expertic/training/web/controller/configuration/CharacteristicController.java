...
import co.expertic.training.service.configuration.CharacteristicService;
...
public class CharacteristicController {
    ...
    public ResponseEntity<ResponseService> createCharacteristic(@RequestBody Characteristic characteristic) {
        ...
        try {  
            ...
            if(listCharacteristicName != null && !listCharacteristicName.isEmpty()) {
                responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.characteristic", "msgNombreExiste"));
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.characteristic", "msgRegistroCreado"));
    ...
    public ResponseEntity<ResponseService> updateCharacteristic(@RequestBody Characteristic characteristic) {
        ...
        try {    
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.characteristic", "msgRegistroEditado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(CharacteristicController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public ResponseEntity<ResponseService> deleteCharacteristic(@RequestBody Characteristic characteristic) {
        ...
        try {           
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.characteristic", "msgRegistroEliminado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(CharacteristicController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public ResponseEntity<ResponseService> createPlanCharacteristic(@RequestBody TrainingPlanCharact trainingPlanCharact) {
        ...
        try {  
            ...
            if(listCharacteristicName != null && !listCharacteristicName.isEmpty()) {
                responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.characteristic", "msgTrainingPlanCharacExiste"));
                responseService.setStatus(StatusResponse.FAIL.getName());
                return new ResponseEntity<>(responseService, HttpStatus.OK);
            }
