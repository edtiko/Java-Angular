...
import co.expertic.training.service.configuration.PhysiologicalCapacityService;
...
public class PhysiologicalCapacityController {
    ...
    public ResponseEntity<ResponseService> createPhysiologicalCapacity(@RequestBody PhysiologicalCapacity physiologicalCapacity) {
        ...
        try {  
            ...
            if(listPhysiologicalCapacityName != null && !listPhysiologicalCapacityName.isEmpty()) {
                responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.physiologicalcapacity", "msgNombreExiste"));
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.physiologicalcapacity", "msgRegistroCreado"));
    ...
    public ResponseEntity<ResponseService> updatePhysiologicalCapacity(@RequestBody PhysiologicalCapacity physiologicalCapacity) {
        ...
        try {    
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.physiologicalcapacity", "msgRegistroEditado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(PhysiologicalCapacityController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public ResponseEntity<ResponseService> deletePhysiologicalCapacity(@RequestBody PhysiologicalCapacity physiologicalCapacity) {
        ...
        try {           
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.physiologicalcapacity", "msgRegistroEliminado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(PhysiologicalCapacityController.class.getName()).log(Level.SEVERE, null, ex);
