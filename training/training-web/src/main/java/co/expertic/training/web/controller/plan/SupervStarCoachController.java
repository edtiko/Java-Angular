...
public class SupervStarCoachController {
    ...
    public ResponseEntity<ResponseService> createSupervStarCoach(@RequestBody SupervStarCoach supervStarCoach) {
        ...
        try {
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.supervstarcoach", "msgRegistroCreado"));
...
//            supervStarCoach.setLastUpdate(new Date());
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.supervstarcoach", "msgRegistroEditado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(SupervStarCoachController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public ResponseEntity<ResponseService> deleteSupervStarCoach(@RequestBody SupervStarCoach supervStarCoach) {
        ...
        try {
            ...
            responseService.setOutput(MessageUtil.getMessageFromBundle("co.expertic.training.i18n.supervstarcoach", "msgRegistroEliminado"));
            responseService.setStatus(StatusResponse.SUCCESS.getName());
            return new ResponseEntity<>(responseService, HttpStatus.OK);
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(SupervStarCoachController.class.getName()).log(Level.SEVERE, null, ex);
